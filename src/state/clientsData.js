...
const get_Local_Clients_Data =localStorage.getItem('clients');
 return{
 data: JSON.parse(get_Local_Clients_Data),
 addNewData(name,email,city){
   const newClient = {id:nanoid(),name,email,city};
